...
public class Studentrollphone {
	    int  rollsam=11;
	    int rolljohn=12;
	    long phonenosam=9303832517L;
	    long phonenojohn=540917206L;
	    String adrrsam="vasbvdm";
	    String addrjohn="fnjcnerm";
	   public static void main(String[] args)
	    {
	       Studentrollphone sam=new Studentrollphone();
	       Studentrollphone john=new Studentrollphone();
